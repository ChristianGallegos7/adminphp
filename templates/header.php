  ...
  <header>
    ...
    <nav class="navbar navbar-expand navbar-light bg-light">
        <div class="nav navbar-nav">
            ...
            <a class="nav-item nav-link" href="<?php echo $url_base;?>sections/empleados/">Empleados</a>
            <a class="nav-item nav-link" href="<?php echo $url_base;?>sections/puestos/">Puestos</a>
